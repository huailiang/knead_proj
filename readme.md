...
随着手机性能的提高，捏脸出现在越来越多的大型手游上，比如说《楚留香》和《完美世界》。在笔者看来捏脸相对于其他模块，还是比较吃性能的，像我所在
的项目，光是脸部的骨骼都达到了100多根。 脸部使用了一张动态生成的RT，大小也是无压缩512的。手机屏也就那么大，所以做这块性价比还是比较低的，在
资源的分配上一定要做好合理的规划，以不至于这块成为游戏性能的瓶颈。
